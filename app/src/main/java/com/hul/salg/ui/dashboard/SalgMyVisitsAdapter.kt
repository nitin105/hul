    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            with(mList[position]) {
                ...
                val number = mList[position].flats_completed!!.size
                binding.visit.text =  mContext.getString(R.string.visit_completed, number)
