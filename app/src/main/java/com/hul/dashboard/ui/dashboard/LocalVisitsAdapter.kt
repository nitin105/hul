...
class LocalVisitsAdapter(
    ...
    inner class ViewHolder(val binding: LocationViewDesignLocalBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            LocationViewDesignLocalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
