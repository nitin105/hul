    ...
    override fun onApiSuccess(o: String?, objectType: Int) {
        when (ApiExtentions.ApiDef.entries[objectType]) {
            ...
            ApiExtentions.ApiDef.GET_VISIT_DATA -> {
                ...
                if (sbForm3DetailsViewModel.visitData.value?.visit_3?.visit_image_4?.value != null) {
                    loadImage(
                        sbForm3DetailsViewModel.visitData.value?.visit_3?.visit_image_4!!.value.toString(),
