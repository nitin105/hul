...
import com.hul.curriculam.ui.form3Details.Form3ViewModel
    ...
    override fun onApiSuccess(o: String?, objectType: Int) {
        ...
        when (ApiExtentions.ApiDef.entries[objectType]) {
            ...
            ApiExtentions.ApiDef.GET_VISIT_DATA -> {
                ...
                if (form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_1?.value != null) {
                    loadImage(
                        form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_1!!.value.toString(),
                        binding.img1, binding.llImg1)
                }

                if (form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_2?.value != null) {
                    loadImage(
                        form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_2!!.value.toString(),
                        binding.img2, binding.llImg2)
                }

                if (form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_3?.value != null) {
                    loadImage(
                        form3ViewModel.visitData.value?.visit_3?.auditor_visit_image_3!!.value.toString(),
